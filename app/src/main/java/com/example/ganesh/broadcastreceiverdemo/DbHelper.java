package com.example.ganesh.broadcastreceiverdemo;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String DROP_TABLE = "drop table if exist " + DbContract.TABLE_NAME;
